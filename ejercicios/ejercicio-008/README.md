...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con futbol sala. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Calcular tabla con goles a favor/en contra.
...
```text
ejercicios/ejercicio-008/resoluciones/nombre-apellido/
+-- futsal-table.js
+-- README.md
```
