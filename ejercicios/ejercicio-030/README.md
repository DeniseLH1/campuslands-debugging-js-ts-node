...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con moba builds. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Validar composicion de objetos unicos.
...
```text
ejercicios/ejercicio-030/resoluciones/nombre-apellido/
+-- moba-build.ts
+-- README.md
```
