...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con playlist de entrenamiento. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Filtrar canciones por energia sin perder datos.
...
```text
ejercicios/ejercicio-006/resoluciones/nombre-apellido/
+-- playlist.js
+-- README.md
```
