...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con animacion 3d. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Calcular frames renderizados por escena.
...
```text
ejercicios/ejercicio-033/resoluciones/nombre-apellido/
+-- render-farm.ts
+-- README.md
```
