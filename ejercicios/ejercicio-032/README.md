...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con paracaidismo. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Validar checklist de salto.
...
```text
ejercicios/ejercicio-032/resoluciones/nombre-apellido/
+-- skydiving.ts
+-- README.md
```
