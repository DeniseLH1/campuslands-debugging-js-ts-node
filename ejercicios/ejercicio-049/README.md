...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con concurrencia simulada. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Evitar carrera al reservar cupos.
...
```text
ejercicios/ejercicio-049/resoluciones/nombre-apellido/
+-- app.js
+-- README.md
```
