...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con battle royale. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Detectar sobrevivientes y zona segura.
...
```text
ejercicios/ejercicio-011/resoluciones/nombre-apellido/
+-- battle-zone.js
+-- README.md
```
