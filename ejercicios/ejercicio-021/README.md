...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con arquitectura 3d. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Validar presupuesto por materiales.
...
```text
ejercicios/ejercicio-021/resoluciones/nombre-apellido/
