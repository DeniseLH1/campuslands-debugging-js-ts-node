...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con ropa streetwear. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Modelar tallas y stock con tipos seguros.
...
```text
ejercicios/ejercicio-023/resoluciones/nombre-apellido/
+-- streetwear-stock.ts
+-- README.md
```
