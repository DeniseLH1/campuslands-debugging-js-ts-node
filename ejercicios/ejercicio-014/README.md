...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con tatuajes. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Validar agenda y duracion de sesiones.
...
```text
ejercicios/ejercicio-014/resoluciones/nombre-apellido/
+-- tattoo-agenda.js
+-- README.md
```
