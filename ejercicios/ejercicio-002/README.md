...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con inventario rpg. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Evitar mutacion inesperada al aplicar pociones.
...
```text
ejercicios/ejercicio-002/resoluciones/nombre-apellido/
+-- inventory.js
+-- README.md
```
