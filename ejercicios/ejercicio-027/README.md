...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con musica. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Detectar BPM fuera de rango por genero.
...
```text
ejercicios/ejercicio-027/resoluciones/nombre-apellido/
+-- bpm-validator.ts
+-- README.md
```
