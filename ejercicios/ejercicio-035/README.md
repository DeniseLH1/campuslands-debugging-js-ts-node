...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con api de jugadores. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Corregir respuesta HTTP y validaciones GET.
...
```text
ejercicios/ejercicio-035/resoluciones/nombre-apellido/
+-- app.js
+-- README.md
```
