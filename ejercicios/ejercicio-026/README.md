...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con libros. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Calcular progreso de lectura por saga.
...
```text
ejercicios/ejercicio-026/resoluciones/nombre-apellido/
+-- book-progress.ts
+-- README.md
```
