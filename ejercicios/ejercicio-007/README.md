...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con peliculas de miedo. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Contar votos y empates correctamente.
...
```text
ejercicios/ejercicio-007/resoluciones/nombre-apellido/
+-- horror-awards.js
+-- README.md
```
