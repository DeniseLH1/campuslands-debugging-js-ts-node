...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con pingpong. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Simular marcador con reglas de ventaja.
...
```text
ejercicios/ejercicio-017/resoluciones/nombre-apellido/
+-- pingpong.js
+-- README.md
```
