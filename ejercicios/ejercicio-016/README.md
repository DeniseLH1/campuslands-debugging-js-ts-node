...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con carreras. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Corregir penalizaciones en tiempos de vuelta.
...
```text
ejercicios/ejercicio-016/resoluciones/nombre-apellido/
+-- racing-laps.js
+-- README.md
```
