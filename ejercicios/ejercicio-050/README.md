...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con depuracion integral. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Resolver multiples fallas en flujo CRUD.
...
```text
ejercicios/ejercicio-050/resoluciones/nombre-apellido/
+-- app.js
+-- README.md
```
