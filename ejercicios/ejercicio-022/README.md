...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con soldadura. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Calcular consumo de varilla por cordon.
...
```text
ejercicios/ejercicio-022/resoluciones/nombre-apellido/
+-- welding.ts
+-- README.md
```
