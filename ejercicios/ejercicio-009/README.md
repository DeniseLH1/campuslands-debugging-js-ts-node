...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con autos hiperdeportivos. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Convertir unidades de velocidad correctamente.
...
```text
ejercicios/ejercicio-009/resoluciones/nombre-apellido/
+-- hypercar.js
+-- README.md
```
