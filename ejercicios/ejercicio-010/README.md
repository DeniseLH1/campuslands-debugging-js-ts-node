...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con pedidos de comida. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Validar estados antes de totalizar pedidos.
...
```text
ejercicios/ejercicio-010/resoluciones/nombre-apellido/
+-- food-orders.js
+-- README.md
```
