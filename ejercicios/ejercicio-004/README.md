...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con torneo moba. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Ordenar ranking por victorias y diferencia.
...
```text
ejercicios/ejercicio-004/resoluciones/nombre-apellido/
+-- moba-ranking.js
+-- README.md
```
