# Resolución del ejercicio 📘✨: Ejercicio 019
...
- Error 2: Error en la función `obtenerPromedio`, dicha funcion realizaba un ordenamiendo ascendente, cuando el expect, esperaba los valores en ordenamiento descendente para obtener el registro con el puntaje más alto.
...
- Causa error 2: La función `obtenerPromedio` tenia invertido los valores en la lógica de ordenamiento.
