...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con personajes rpg. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Corregir tipos y calculo de poder total.
...
```text
ejercicios/ejercicio-019/resoluciones/nombre-apellido/
+-- rpg-character.ts
+-- README.md
```
