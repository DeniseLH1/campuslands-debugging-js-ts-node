...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con tienda de skins. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Corregir descuento y redondeo de precios.
...
```text
ejercicios/ejercicio-003/resoluciones/nombre-apellido/
+-- skins.js
+-- README.md
```
