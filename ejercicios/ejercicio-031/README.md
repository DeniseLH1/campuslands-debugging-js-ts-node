...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con autos de lujo. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Ordenar catalogo por potencia/precio.
...
```text
ejercicios/ejercicio-031/resoluciones/nombre-apellido/
+-- luxury-cars.ts
+-- README.md
```
