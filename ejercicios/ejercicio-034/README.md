...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con turismo. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Filtrar paquetes por presupuesto y temporada.
...
```text
ejercicios/ejercicio-034/resoluciones/nombre-apellido/
+-- tourism.ts
+-- README.md
```
