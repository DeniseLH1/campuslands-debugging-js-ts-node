...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con equipo de esports. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Usar tipos para roles validos y suplentes.
...
```text
ejercicios/ejercicio-020/resoluciones/nombre-apellido/
+-- esports-team.ts
+-- README.md
```
