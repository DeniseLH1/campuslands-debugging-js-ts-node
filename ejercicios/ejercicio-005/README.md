...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con motos en taller. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Validar kilometraje y mantenimientos vencidos.
...
```text
ejercicios/ejercicio-005/resoluciones/nombre-apellido/
+-- moto-service.js
+-- README.md
```
