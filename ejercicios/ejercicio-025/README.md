...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con mecanica de motos. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Diagnosticar fallas por sintomas.
...
```text
ejercicios/ejercicio-025/resoluciones/nombre-apellido/
+-- moto-diagnostics.ts
+-- README.md
```
