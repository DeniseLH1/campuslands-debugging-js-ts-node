...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con ciencia ficcion. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Clasificar misiones por riesgo.
...
```text
ejercicios/ejercicio-024/resoluciones/nombre-apellido/
+-- space-missions.ts
+-- README.md
```
