...
Un equipo de desarrollo de Campuslands recibio una funcionalidad relacionada con api de motos. El codigo ya existe, pero contiene uno o varios errores intencionales. Tu tarea es comportarte como desarrollador en revision: reproducir el fallo, entender la causa y corregirlo sin romper el contrato esperado.

## Objetivo

Arreglar creacion POST y codigos 201/400.
...
```text
ejercicios/ejercicio-036/resoluciones/nombre-apellido/
+-- app.js
+-- README.md
```
